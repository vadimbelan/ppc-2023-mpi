...
#ifndef TASKS_TASK_2_POLOZOV_V_GAUSS_JORDAN_METHOD_H_
#define TASKS_TASK_2_POLOZOV_V_GAUSS_JORDAN_METHOD_H_
...
#endif  // TASKS_TASK_2_POLOZOV_V_GAUSS_JORDAN_METHOD_H_
