...
TEST(MonteCarloIntegral, Pow1Var) {
    ...
    if (rank == 0) {
        ASSERT_LT(std::abs(parallelRes - 41.66666666666666), 5);
    }
}
...
TEST(MonteCarloIntegral, Cos1Var) {
    ...
    if (rank == 0) {
        ASSERT_LT(std::abs(parallelRes - (-0.9589242746631386)), 0.5);
    }
}
...
TEST(MonteCarloIntegral, Exp2Var) {
    ...
    if (rank == 0) {
        ASSERT_LT(std::abs(parallelRes - 0.986569), 0.5);
    }
}
...
TEST(MonteCarloIntegral, Sin2Var) {
    ...
    if (rank == 0) {
        ASSERT_LT(std::abs(parallelRes - (-66.082)), 5);
    }
}
...
TEST(MonteCarloIntegral, Sum2Var) {
    ...
    if (rank == 0) {
        ASSERT_LT(std::abs(parallelRes), 5);
    }
}
