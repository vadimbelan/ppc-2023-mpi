...
TEST(Matrix_Cannon_multiply, Test_1) {
...
TEST(Matrix_Cannon_multiply, Test_2) {
    boost::mpi::communicator world;
    int size = 3;
...
TEST(Matrix_Cannon_multiply, Test_3) {
    boost::mpi::communicator world;
    int size = 10;
    std::vector<std::vector<double>> a;
    std::vector<std::vector<double>> b;
...
TEST(Matrix_Cannon_multiply, Test_4) {
    boost::mpi::communicator world;
    int size = 6;
    std::vector<std::vector<double>> a(size, std::vector<double>(size));
    std::vector<std::vector<double>> b(size, std::vector<double>(size));
...
TEST(Matrix_Cannon_multiply, Test_5) {
    boost::mpi::communicator world;
    int size = 7;
    std::vector<std::vector<double>> a(size, std::vector<double>(size));
    std::vector<std::vector<double>> b(size, std::vector<double>(size));
